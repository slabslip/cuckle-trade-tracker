...
import { applyRedraftSeason, applyRedraftSeasons, champBySeasonFromTitles, GM_POT, REDRAFT_PLACE_RULE } from "./lib/redraft-season.mjs";
...
const book = buildFinishesBook({
  ...
  pot: format.kind === "redraft" ? GM_POT : undefined,
});
