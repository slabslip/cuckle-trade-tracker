...
Optional local cron (Sunday morning, adjust the path):

```cron
20 9 * * 0 cd /Users/trumancooper/Desktop/cuckle-trade-tracker && /usr/bin/node ktc-snapshot.mjs >> data/ktc/cron.log 2>&1
```
