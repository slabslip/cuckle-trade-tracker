...
| **HIG-21** | No More header | Menu rows only — no gold-mark **More** header. Rows right-align (label then icon). No second toolbar. No filter sliders. No + FAB. |
...
- Menu (`HIG-19`…`HIG-22`): separate card above the pill, not a morph. No More
  header. Rows right-align (label then icon) with a gold capsule, no dividers. Closed
