...
| Surface | Proof job |
|---------|-----------|
| **Home** | No personal bag hero. Calling card + name/place tab only — no tape line. Team Ideas / calc stay *today’s* deal. The top 4 doors from Your board sit here for instant access. A proof chip does not remount News. |
