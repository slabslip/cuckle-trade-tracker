...
4. **Whether news should ever be per-seat.** **Settled for Home.** The News Feed pull-up stays
   league-wide. Home does **not** remount a personal injury / roster strip. Manager tags still
   show on cards inside the feed. Signed-out Home does not duplicate the peek.
