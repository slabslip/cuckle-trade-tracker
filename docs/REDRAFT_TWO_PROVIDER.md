...
- Final standings stay concrete: top six from the playoff bracket, bottom six from regular-season record (last = worst record). Only leftover scores drop from point averages.
