...
Planning archive: [`plans/ledger_and_league_tab.md`](plans/ledger_and_league_tab.md), [`plans/ledger_privacy_views.md`](plans/ledger_privacy_views.md) (shipped); [`plans/ledger_join_exposure.md`](plans/ledger_join_exposure.md) (v1.1); [`plans/ledger_compose_and_alerts.md`](plans/ledger_compose_and_alerts.md) (v1.2 Add bet + bell, v1.3 SMS).
