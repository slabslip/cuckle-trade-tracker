...
| Tab | HAVE |
| --- | --- |
| Home | No team = scrolling fact bubbles, then collapsed Best/Worst aged + player lists (tap to expand). Dropdown picks a team → that team’s home (hero + latest trades/rookies). |
