...
| Tab | HAVE |
| --- | --- |
| Home | No team = league Best/Worst aged boards, then Most passed around / Least traded / Forever players / Homesteaders. Dropdown picks a team → that team’s home (hero + latest trades/rookies). |
