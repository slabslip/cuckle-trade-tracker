...
| Tab | HAVE |
| --- | --- |
| Home | No team = scrolling fact bubbles, then collapsed Best/Worst + player lists (tap to expand). Tape middle = this chip’s rounded received − sent. Dropdown picks a team → that team’s home. |
