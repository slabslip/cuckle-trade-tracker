...
Equip one title + one emblem. Every award unlocks **both** kinds (shared `pair` key). Your emblem
paints on **your** seat name; title shows on the calling card / Profile plate.
