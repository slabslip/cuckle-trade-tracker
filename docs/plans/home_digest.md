...
**Status:** Shipped — first tab **Home**, signed-in Your 3, one in-flow news story, 2-team
calculator on the today / `even` book, 25 titles/emblems + barracks.
...
- Hybrid Home: league water cooler on top (one Recent Trade + **Price a deal** + one news story
  + existing News Feed peek). Signed-in **Your 3** under that — actions only, no bag hero.
- Your 3 (omit empties, omit when signed out): Ledger involving you; an uncast vote on the deal
  on this page; one roster-tagged news hit or “Price a deal”.
