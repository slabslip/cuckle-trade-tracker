...
- Calculator is `?view=calc`, not a tab. 2-team, rostered players + still-held picks, today /
  ...
  Team Ideas even talks use the same receive+VA totals. Votes never enter the number.
...
**Next Home bet (not built):** Overnight Slip — [`dynasty_daily_habit.md`](./dynasty_daily_habit.md).
