...
<body>
  ...
  <script>
    ...
    function renderLeagueHome() {
      ...
      const gate = n
        ? '<button type="button" class="row" data-view="titles">'
          + '<div class="row-top"><div><div class="names">Champions path</div>'
          + '<div class="date">' + n + " title years · how they actually won</div></div>"
          + '<div class="date">Open</div></div></button>'
        : "";
      return gate
        + dayAlert()
        + lensRow()
