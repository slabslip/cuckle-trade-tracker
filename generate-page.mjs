...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .chip-lens { position: absolute; top: 0; right: 0; z-index: 3; line-height: 0; }
    .chip-lens.is-inline {
    ...
    .h2h-chip.is-trade { position: relative; padding-top: 16px; padding-right: 20px; }
    .h2h-chip.is-trade > .chip-lens { top: 0; right: 0; }
...
<body>
  ...
  <script>
    ...
    let lens = "all";
    const DATA_V = "cuffsUninsuredCol20260901144500";
    /**
    ...
    function chipLensIcon() {
      return '<svg class="chip-lens-ico" viewBox="0 0 16 16" width="11" height="11" aria-hidden="true" focusable="false">'
