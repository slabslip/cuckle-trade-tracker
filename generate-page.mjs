  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    button.who {
      ...
      min-height: 44px; padding: 6px 28px 6px 10px; margin: 0; cursor: pointer;
      overflow: hidden; text-overflow: ellipsis; white-space: nowrap;
    }
    button.who:focus-visible { outline: 2px solid #c8c8d0; outline-offset: 2px; }
    /* The brand plus the picker needed 394px of a 343px row at 375px, so the picker ran
    ...
    a.champ-alert .champ-line { color: var(--text); font-weight: 700; line-height: 1.3; margin-top: 4px; }
    a.champ-alert .date { line-height: 1.35; margin-top: 1px; }
    button.day-in {
      display: block; width: 100%; appearance: none; font: inherit; color: inherit;
...
<body>
  ...
  <script>
    ...
    function writeVote(transactionId, choice) {
      ...
      else box.votes[transactionId] = { choice: choice, seat: voteSeatId(), ts: new Date().toISOString() };
      voteBoxWrite(box);
    }
