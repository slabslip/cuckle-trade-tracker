...
/** $300 buy-in, 12 teams, $3,600 pot. Placeholder until the commish posts the real top-six sheet. */
export const GM_ENTRY = 300;
export const GM_PAYOUTS = { 1: 1500, 2: 900, 3: 500, 4: 360, 5: 200, 6: 140 };
export const GM_POT = {
  entry: GM_ENTRY,
  teams: 12,
  pot: 3600,
  note: "Placeholder top-six payout. $300 entry, $3,600 pot. Consolation is unpaid.",
  payouts: GM_PAYOUTS,
};
