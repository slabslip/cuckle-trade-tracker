...
CUSTOM_TITLE_MASTERS = {
    ...
    "champion": DESIGN / "ff-title-champion-comic-v1.png",
    ...
    "five_time": DESIGN / "ff-title-five_time-comic-v1.png",
    "founding_draft": DESIGN / "ff-title-founding_draft-comic-v1.png",
    "four_time": DESIGN / "ff-title-four_time-comic-v1.png",
    ...
    "repeat": DESIGN / "ff-title-repeat-comic-v1.png",
    ...
    "three_peat": DESIGN / "ff-title-three_peat-comic-v1.png",
    "three_time": DESIGN / "ff-title-three_time-comic-v1.png",
    "three_time_finalist_title": DESIGN / "ff-title-three_time_finalist_title-comic-v1.png",
    "two_time": DESIGN / "ff-title-two_time-comic-v1.png",
