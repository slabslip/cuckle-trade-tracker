...
loop(10, page.includes('const DATA_V = "teamhomemenu20260920020000"')
  && html.includes('const DATA_V = "teamhomemenu20260920020000"')
  && sw.includes('chuckle-shell-v309-team-home-menu')
