...
loop(10, page.includes('const DATA_V = "overnight20260919220000"')
  && html.includes('const DATA_V = "overnight20260919220000"')
  && sw.includes('chuckle-shell-v294-overnight-report')
