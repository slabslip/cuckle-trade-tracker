...
loop(10, page.includes('const DATA_V = "analyzernow20260920020000"')
  && html.includes('const DATA_V = "analyzernow20260920020000"')
  && sw.includes('chuckle-shell-v313-analyzer-now')
