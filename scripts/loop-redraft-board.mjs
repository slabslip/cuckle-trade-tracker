...
loop(10, page.includes('const DATA_V = "analyzerloops20260919224500"')
  && html.includes('const DATA_V = "analyzerloops20260919224500"')
  && sw.includes('chuckle-shell-v302-analyzer-loops')
