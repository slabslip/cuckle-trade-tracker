...
loop(10, page.includes('const DATA_V = "analyzerloops20260920015000"')
  && html.includes('const DATA_V = "analyzerloops20260920015000"')
  && sw.includes('chuckle-shell-v311-analyzer-loops')
