...
loop(10, page.includes('const DATA_V = "overnight20260919213000"')
  && html.includes('const DATA_V = "overnight20260919213000"')
  && sw.includes('chuckle-shell-v293-overnight-dynasty')
