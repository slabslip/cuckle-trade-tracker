...
loop(10, page.includes('const DATA_V = "analyzerdraft20260920023000"')
  && html.includes('const DATA_V = "analyzerdraft20260920023000"')
  && sw.includes('chuckle-shell-v310-analyzer-draft')
