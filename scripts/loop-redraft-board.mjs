...
loop(10, page.includes('const DATA_V = "teamhomemenu20260920013500"')
  && html.includes('const DATA_V = "teamhomemenu20260920013500"')
  && sw.includes('chuckle-shell-v307-team-home-menu')
