...
loop(10, page.includes('const DATA_V = "analyzergrades20260919223000"')
  && html.includes('const DATA_V = "analyzergrades20260919223000"')
  && sw.includes('chuckle-shell-v301-analyzer-grades')
