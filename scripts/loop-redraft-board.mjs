...
loop(10, page.includes('const DATA_V = "analyzerspread20260920015500"')
  && html.includes('const DATA_V = "analyzerspread20260920015500"')
  && sw.includes('chuckle-shell-v312-analyzer-spread')
